...
public final class DownloadProvider extends ContentProvider {
    ...
    /** AUTHORITY. */
    public static final String AUTHORITY = "com.baidu.searchbox.downloads";
    
    /** 不检查 permission ，add by caoahitao. */
     ...
     */
    private static String[] sAppReadableColumnsArray = new String[] {
        Downloads.Impl._ID,
        ...
        // Add by liuxinjian 2013.12.21 Begin
        // 增加这一列，解决的问题：静默下载浏览内核/播放内核中，此时覆盖升级安装新版本的框APP.
        // 此中case下，须会在SearchboxUpgradeMananger中判断：删除未下载完成的内核文件.
        // 因此会查询下载数据库，is_publis_api字段会被查询。而升级的时候，shouldRestrictVisibility()函数有可能会返回true。
        // 进而导致异常：java.lang.IllegalArgumentException: column is_public_api is not allowed in queries
        Downloads.Impl.COLUMN_IS_PUBLIC_API,
        // Add by liuxinjian 2013.12.21 End
    };
    ...
    private static final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private void upgradeTo(SQLiteDatabase db, int version) {
            switch (version) {
                case 100: // SUPPRESS CHECKSTYLE
                    createDownloadsTable(db);
                    break;

                case 101: // SUPPRESS CHECKSTYLE
                    createHeadersTable(db);
                    break;

                case 102: // SUPPRESS CHECKSTYLE
    ...
    public boolean onCreate() {
        ...
        /*
         * delete by caohaitao. not needed.
         * 
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        boolean isPublicApi =
            Boolean.TRUE.equals(values.getAsBoolean(Downloads.Impl.COLUMN_IS_PUBLIC_API));
    ...
    private void checkFileUriDestination(ContentValues values) {
        ...
        //modify by dongqi,in case kernel can't be downloaded in internal storage
...
//        }
    ...
    private void checkInsertPermissions(ContentValues values) {
        // <add by caohaitao 20110728 begin
        if (!CHECK_PERMISSION) {
            return;
        }
        // <add by caohaitao 20110728 end>
    ...
    /**
     * true if we should restrict the columns readable by this caller
    ...
    public int update(final Uri uri, final ContentValues values,
        ...
        if (Binder.getCallingPid() != Process.myPid()) {
            ...
            copyInteger(Constants.MEDIA_SCANNED, values, filteredValues); // add by caohaitao
        } else {
            filteredValues = values;
            String filename = values.getAsString(Downloads.Impl.DATA);
            if (filename != null) {
        ...
        switch (match) {
            ...
            default:
                ...
                // <modify by hexingzhou 不抛出异常，直接返回未更新值，0
                return 0;
                // <end
        }
    ...
    /**
     * copyInteger from source to dest.
     * @param key key want to copy
     * @param from source
    ...
    /**
     * copyBoolean from source to dest.
     * @param key key want to copy
     * @param from source
     * @param to destination
     */
    ...
    /**
     * copyString from source to dest.
     * @param key key want to copy
     * @param from source
     * @param to destination
     */
    ...
    /**
     * copyStringWithDefault from source to dest.
     * @param key key want to copy
     * @param from source
     * @param to destination
