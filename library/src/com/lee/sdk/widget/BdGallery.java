 ...
 * <p>
 * The default values for the BdGallery assume you will be using
 * {@link android.R.styleable#Theme_galleryItemBackground} as the background for each View given to
 * the BdGallery from the Adapter. If you are not doing this, you may need to adjust some BdGallery
 * properties, such as the spacing.
 * <p>
 * Views given to the BdGallery should use {@link BdGallery.LayoutParams} as their layout parameters
 * type.
 * 
 ...
 */
public class BdGallery extends BdAbsSpinner implements GestureDetector.OnGestureListener,
    ...
    public BdGallery(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.galleryStyle);
    }

    public BdGallery(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Sets the spacing between items in a BdGallery
     * 
     * @param spacing The spacing in pixels between items in the BdGallery
     * 
     * @attr ref android.R.styleable#Gallery_spacing
     */
    ...
    /**
     * Sets the alpha of items that are not selected in the BdGallery.
     * 
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        /*
         * BdGallery expects BdGallery.LayoutParams.
         */
        return new BdGallery.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    }
    ...
    /**
     * @return The center of this BdGallery.
     */
    ...
    /**
     * Detaches children that are off the screen (i.e.: BdGallery bounds).
     * 
     * @param toLeft Whether to detach children to the left of the BdGallery, or to the right.
     */
    ...
    /**
     * Creates and positions all views for this BdGallery.
     * <p>
    ...
    private void setUpChild(View child, int offset, int x, boolean fromLeft) {
        ...
        // make some up...
        BdGallery.LayoutParams lp = (BdGallery.LayoutParams) child.getLayoutParams();
        if (lp == null) {
            lp = (BdGallery.LayoutParams) generateDefaultLayoutParams();
        }
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
         ...
         * intercepted them by now (for example, we can assume when a BdGallery is in the ListView, a
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        // BdGallery steals all key events
    ...
    /**
     * BdGallery extends LayoutParams to provide a place to hold current Transformation information
    ...
    /**
     * @param orientation the m_orientation to set, one of {@link BdGallery#HORIZONTAL} or {@link BdGallery#VERTICAL}.
     */
    ...
    /**
     * This interface defines methods for BdGallery.
     * 
     * @author LeeHong
     */
    public interface OnEndFlingListener {
         ...
         */
        public void onEndFling(BdGallery v);
    }
    //
    // Added by LiHong at 2011/08/12 end ============================================.
}
