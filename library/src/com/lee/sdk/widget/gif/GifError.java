...
/**
 * Encapsulation of decoding errors ocurring in native code. Three digit codes are equal to GIFLib
 * error codes.
 * 
 * @author koral--
 */
public enum GifError {
    ...
    /**
     * Image EOF detected before image complete. EOF means GIF terminator, NOT end of input source.
     */
