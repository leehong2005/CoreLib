 ...
 * 
 * The function decodeFileDescriptor() is used to decode a bitmap. During decoding if another thread
 * wants to cancel it, it calls the function cancelThreadDecoding() specifying the Thread which is
 * in decoding.
 * 
...
public class BitmapManager {
    ...
    /**
     * The following three methods are used to keep track of BitmapFaction.Options used for decoding
     * and cancelling.
     */
    ...
    /**
     * The following three methods are used to keep track of which thread is being disabled for
     * bitmap decoding.
     */
