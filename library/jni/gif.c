...
Java_com_lee_sdk_widget_gif_GifDecoder_openFile(JNIEnv * env, jclass class,
...
JNIEXPORT jint JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_openByteArray(JNIEnv * env, jclass class,
...
JNIEXPORT jint JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_openDirectByteBuffer(JNIEnv * env,
...
JNIEXPORT jint JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_openStream(JNIEnv * env, jclass class,
...
JNIEXPORT jint JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_openFd(JNIEnv * env, jclass class,
...
Java_com_lee_sdk_widget_gif_GifDecoder_reset(JNIEnv * env, jclass class,
        jint gifInfo)
{
...
Java_com_lee_sdk_widget_gif_GifDecoder_setSpeedFactor(JNIEnv * env, jclass class,
...
JNIEXPORT void JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_seekToTime(JNIEnv * env, jclass class,
...
JNIEXPORT void JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_seekToFrame(JNIEnv * env, jclass class,
...
JNIEXPORT void JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_renderFrame(JNIEnv * env, jclass class,
...
JNIEXPORT void JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_free(JNIEnv * env, jclass class,
        jint gifInfo)
{
...
Java_com_lee_sdk_widget_gif_GifDecoder_getComment(JNIEnv * env, jclass class,
        jint gifInfo)
{
    if (gifInfo == (jint) NULL)
        return NULL;
...
JNIEXPORT jint JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_getLoopCount(JNIEnv * env, jclass class,
        jint gifInfo)
{
    if (gifInfo ==(jint) NULL)
        return 0;
...
JNIEXPORT jint JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_getDuration(JNIEnv * env, jclass class,
        jint gifInfo)
{
    GifInfo* info = (GifInfo*) gifInfo;
    if (info == NULL)
...
JNIEXPORT jint JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_getCurrentPosition(JNIEnv * env,
...
JNIEXPORT void JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_saveRemainder(JNIEnv * env, jclass class,
        jint gifInfo)
{
    GifInfo* info = (GifInfo*) gifInfo;
    if (info == NULL)
...
JNIEXPORT void JNICALL
Java_com_lee_sdk_widget_gif_GifDecoder_restoreRemainder(JNIEnv * env,
        jclass class, jint gifInfo)
{
    GifInfo* info = (GifInfo*) gifInfo;
...
Java_com_lee_sdk_widget_gif_GifDecoder_getAllocationByteCount(JNIEnv * env,
        jclass class, jint gifInfo)
{
    GifInfo* info = (GifInfo*) gifInfo;
    if (info == NULL)
