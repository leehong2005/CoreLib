 ...
 * {@hide}
 */
public class TosScrollBarDrawable extends Drawable {
    ...
    protected final Rect mThumbBounds = new Rect();
    protected final Rect mTrackBounds = new Rect();
    private boolean mAlwaysDrawHorizontalTrack;
    private boolean mAlwaysDrawVerticalTrack;

    public TosScrollBarDrawable() {
    }
    ...
    public void getThumbBound(Rect bounds) {
        if (null != bounds) {
            bounds.set(mThumbBounds);
        }
    }
    
    public void getTrackBound(Rect bounds) {
        if (null != bounds) {
            bounds.set(mTrackBounds);
        }
    }
    ...
    public void setThumbPressed(boolean pressed) {
        if (null != mVerticalThumb) {
            //int stateSet[] = { 0 };
            //stateSet[0] = pressed ? android.R.attr.state_pressed : 0;
            //mVerticalThumb.setState(stateSet);
        }
        
        if (null != mHorizontalThumb) {
