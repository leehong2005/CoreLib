...
public class WheelViewPasswordActivity extends GABaseActivity {
    ...
    private BdAdapterView.OnItemSelectedListener mListener = new BdAdapterView.OnItemSelectedListener() {
        @Override
    ...
    private class NumberAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (null == convertView) {
                ...
                convertView.setLayoutParams(new BdGallery.LayoutParams(-1, mHeight));
