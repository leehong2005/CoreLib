...
public class GifImageView extends ImageView {
    ...
    /**
     * Like eqivalent from superclass but also try to interpret src and background attributes as
     * {@link GifDrawable}.
     * 
     * @param context
     * @param attrs
    ...
    /**
     * Sets the content of this GifImageView to the specified Uri. If uri destination is not a GIF
     * then {@link android.widget.ImageView#setImageURI(android.net.Uri)} is called as fallback. For
     * supported URI schemes see:
