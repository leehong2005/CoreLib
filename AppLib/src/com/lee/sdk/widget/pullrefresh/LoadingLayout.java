...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    protected void init(Context context, AttributeSet attrs) {
        mContainer = createLoadingView(context, this, attrs);
        if (null == mContainer) {
            throw new NullPointerException("Loading view can not be null.");
        }
        
        int height = LayoutParams.WRAP_CONTENT;
        ViewGroup.LayoutParams oldParams = mContainer.getLayoutParams();
        if (null != oldParams) {
    ...
    /**
     * 创建Loading的View，注意传入的root参数的目的只是为了生成layout parameter，在调用{@link LayoutInflater#inflate(int, ViewGroup)}
     * 方法inflate布局的时候<b>不能</b>将<em>attachToRoot</em>设置为true，否则会出异常。
     * 
     * @param context context
     * @param root Optional view to be the parent of the generated hierarchy or else simply an object that
     *        provides a set of LayoutParams values for root of the returned.
     * @param attrs attrs
     * @return Loading的View
     */
    protected abstract View createLoadingView(Context context, ViewGroup root, AttributeSet attrs);
}
