...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mArrowImageView.setImageResource(R.drawable.sdk_pull_refresh_rotate);
    ...
    protected View createLoadingView(Context context, ViewGroup root, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.sdk_pull_to_refresh_header2, root, false);
        return container;
    }
