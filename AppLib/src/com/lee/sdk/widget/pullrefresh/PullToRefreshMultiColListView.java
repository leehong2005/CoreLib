...
import com.lee.sdk.widget.pullrefresh.ILoadingLayout.State;
 ...
 * @since 2013-8-15
 */
public class PullToRefreshMultiColListView extends PullToRefreshBase<BdMultiColumnListView> implements OnScrollListener {
     ...
     * @param attrs attrs
     */
    public PullToRefreshMultiColListView(Context context, AttributeSet attrs) {
     ...
     */
    public PullToRefreshMultiColListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    @Override
    protected BdMultiColumnListView createRefreshableView(Context context, AttributeSet attrs) {
        BdMultiColumnListView listView = new BdMultiColumnListView(context, attrs);
        mListView = listView;
