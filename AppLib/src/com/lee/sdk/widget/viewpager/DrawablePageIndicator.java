...
public class DrawablePageIndicator extends View implements PageIndicator {
    ...
    public DrawablePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiDrawablePageIndicatorStyle);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mDrawable.setBounds((int) (left - mShadowLeft), (int) top, (int) (right + mShadowRight), (int) bottom);
