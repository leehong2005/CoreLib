...
public abstract class BdAbsSpinner extends BdAdapterView<SpinnerAdapter> {
    ...
    public BdAbsSpinner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BdAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
    ...
    void recycleAllViews() {
        ...
        final BdAbsSpinner.RecycleBin recycleBin = mRecycler;
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link BdAbsSpinner#onSaveInstanceState()}
         */
        ...
        public String toString() {
            return "BdAbsSpinner.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " selectedId="
