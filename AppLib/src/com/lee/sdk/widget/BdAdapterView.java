...
/**
 * An BdAdapterView is a view whose children are determined by an {@link Adapter}.
 * 
 * <p>
 * See {@link ListView}, {@link GridView}, {@link Spinner} and {@link BdGallery} for commonly used
 * subclasses of BdAdapterView.
 */
public abstract class BdAdapterView<T extends Adapter> extends ViewGroup {
    ...
    /**
     * The offset in pixels from the top of the BdAdapterView to the top of the view to select during
     * the next layout.
     */
    int mSpecificTop;
    ...
    public BdAdapterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BdAdapterView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    /**
     * Interface definition for a callback to be invoked when an item in this BdAdapterView has been
     * clicked.
     */
    public interface OnItemClickListener {

        /**
         * Callback method to be invoked when an item in this BdAdapterView has been clicked.
         * <p>
         * Implementers can call getItemAtPosition(position) if they need to access the data
         * associated with the selected item.
         * 
         * @param parent The BdAdapterView where the click happened.
         * @param view The view within the BdAdapterView that was clicked (this will be a view
         *            provided by the adapter)
         * @param position The position of the view in the adapter.
         * @param id The row id of the item that was clicked.
         */
        void onItemClick(BdAdapterView<?> parent, View view, int position, long id);
    }

    /**
     * Register a callback to be invoked when an item in this BdAdapterView has been clicked.
     * 
    ...
    /**
     * @return The callback to be invoked with an item in this BdAdapterView has been clicked, or null
     ...
     * 
     * @param view The view within the BdAdapterView that was clicked.
     * @param position The position of the view in the adapter.
     * @param id The row id of the item that was clicked.
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(BdAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemDoubleClickListener {
         ...
         * @return true if the callback consumed the long click, false otherwise
         */
        boolean onItemDoubleClick(BdAdapterView<?> parent, View view, int position, long id);
    }

    // Added by LiHong at 2012/02/03 end =======================

    /**
     * Register a callback to be invoked when an item in this BdAdapterView has been clicked and held
     * 
    ...
    /**
     * @return The callback to be invoked with an item in this BdAdapterView has been clicked and
    ...
    public interface OnItemSelectedListener {
         ...
         * associated with the selected item.
         * 
         * @param parent The BdAdapterView where the selection happened
         * @param view The view within the BdAdapterView that was clicked
         * @param position The position of the view in the adapter
         * @param id The row id of the item that is selected
         */
        void onItemSelected(BdAdapterView<?> parent, View view, int position, long id);
         ...
         * 
         * @param parent The BdAdapterView that now contains no selected item.
         */
        void onNothingSelected(BdAdapterView<?> parent);
    }

    /**
     * Register a callback to be invoked when an item in this BdAdapterView has been selected.
     * 
     * @param listener The callback that will run
     */
     ...
     * callback when a context menu is brought up for this BdAdapterView.
     * 
     */
    public static class AdapterContextMenuInfo implements ContextMenu.ContextMenuInfo {
         ...
         * children of this BdAdapterView.
         */
    ...
    /**
     * @return The number of items owned by the Adapter associated with this BdAdapterView. (This is
     ...
     *            BdAdapterView at the time of the call.
    ...
    /**
     * When the current adapter is empty, the BdAdapterView can display a special view call the empty
    ...
    public void setOnClickListener(OnClickListener l) {
        throw new RuntimeException("Don't call setOnClickListener for an BdAdapterView. "
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (BdAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0
                    && mItemCount > 0) {
                BdAdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (BdAdapterView.this.getAdapter().hasStableIds()) {
                ...
                mInstanceState = BdAdapterView.this.onSaveInstanceState();
            }
    ...
    private class SelectionNotifier extends Handler implements Runnable {
        public void run() {
            if (mDataChanged) {
                ...
                // was posted and now. We need to wait until the BdAdapterView
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        ...
        // current focus/selection. BdAdapterView fires selection but not focus
        // events so we change the event type here.
        if (event.getEventType() == AccessibilityEvent.TYPE_VIEW_FOCUSED) {
            event.setEventType(AccessibilityEvent.TYPE_VIEW_SELECTED);
        }

        // we send selection events only from BdAdapterView to avoid
