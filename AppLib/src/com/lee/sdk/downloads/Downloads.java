...
public final class Downloads {
    ...
    public static final String PERMISSION_ACCESS_ADVANCED =
            "com.baidu.searchbox.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";
    ...
    public static final String PERMISSION_SEND_INTENTS =
            "com.baidu.searchbox.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";
    ...
    public static final Uri CONTENT_URI =
        Uri.parse("content://" + "com.baidu.searchbox.downloads" + "/my_downloads");
    ...
    public static final String ACTION_DOWNLOAD_COMPLETED =
            "com.baidu.searchbox.intent.action.DOWNLOAD_COMPLETED";
     ...
     * @hide
     */
    public static final String DATA = "_data"; // _DATA
     ...
     * @hide
     * @param status status
     * @return Returns whether the status is informational (i.e. 1xx).
     */
    public static boolean isStatusInformational(int status) {
        return (status >= 100 && status < 200); // SUPPRESS CHECKSTYLE
    }
     ...
     * @hide
     * @param status status
     * @return Returns whether the status is a success (i.e. 2xx).
     */
    public static boolean isStatusSuccess(int status) {
        return (status >= 200 && status < 300); // SUPPRESS CHECKSTYLE
    }
     ...
     * @hide
     * @param status status
     * @return Returns whether the status is an error (i.e. 4xx or 5xx).
     */
    public static boolean isStatusError(int status) {
        return (status >= 400 && status < 600); // SUPPRESS CHECKSTYLE
    }
     ...
     * @hide
     * @param status status
     * @return Returns whether the status is a client error (i.e. 4xx).
     */
    public static boolean isStatusClientError(int status) {
        return (status >= 400 && status < 500); // SUPPRESS CHECKSTYLE
    }
     ...
     * @hide
     * @param status status
     * @return Returns whether the status is a server error (i.e. 5xx).
     */
    public static boolean isStatusServerError(int status) {
        return (status >= 500 && status < 600); // SUPPRESS CHECKSTYLE
    }
     ...
     * @hide
     * @param status status
     * @return Returns whether the download has completed (either with success or error).
     */
    public static boolean isStatusCompleted(int status) {
        return (status >= 200 && status < 300) || (status >= 400 && status < 600); // SUPPRESS CHECKSTYLE
    }
    ...
    public static final class Impl implements BaseColumns {
        ...
        public static final String PERMISSION_ACCESS_ALL =
                "com.baidu.searchbox.permission.ACCESS_ALL_DOWNLOADS";
        ...
        public static final String PERMISSION_CACHE_NON_PURGEABLE =
                "com.baidu.searchbox.permission.DOWNLOAD_CACHE_NON_PURGEABLE";
        ...
        public static final String PERMISSION_NO_NOTIFICATION =
                "com.baidu.searchbox.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
        ...
        public static final Uri ALL_DOWNLOADS_CONTENT_URI =
                Uri.parse("content://" + "com.baidu.searchbox.downloads" + "/all_downloads");
    ...
    /**
     * 设置下载位置管理模式。
     * @param mode {@link DestinationMode#AUTO AUTO}, 
     *              {@link DestinationMode#INTERNAL_ONLY INTERNAL_ONLY}, 
     *              {@link DestinationMode#EXTERNAL_ONLY EXTERNAL_ONLY},
     *              {@link DestinationMode#CUSTOM CUSTOM} 
     */
    public static void setDestinationMode(DestinationMode mode) {
        sDestinationMode = mode;
    }
    
    /**
     * 设置自定义下载目录。
     * @param dir 自定义下载目录，只有当下载模式为{@link DestinationMode#CUSTOM CUSTOM}时才有效，其他模式可设为null.
     */
    ...
    /**
     * 获取下载位置管理模式。
     * @return {@link DestinationMode#AUTO AUTO}, 
     *          {@link DestinationMode#INTERNAL_ONLY INTERNAL_ONLY}, 
     *          {@link DestinationMode#EXTERNAL_ONLY EXTERNAL_ONLY},
     *          {@link DestinationMode#CUSTOM CUSTOM} 
     */
