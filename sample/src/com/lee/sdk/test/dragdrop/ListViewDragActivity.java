...
import com.lee.sdk.widget.DragListView;
import com.lee.sdk.widget.DragListView.IDragAdapter;

public class ListViewDragActivity extends GABaseActivity {
    ...
    private void initialize() {
        ...
        for (int i = 0; i < count; ++i) {
            mDatas.add(sCheeseStrings[i]);
        }
    }

    private class ListViewAdapter extends BaseAdapter implements IDragAdapter {
        private int mHidePosition = -1;
        private int mHeight = 80;

        public ListViewAdapter() {
            mHeight = (int) Utils.pixelToDp(ListViewDragActivity.this, mHeight);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ListViewItem textView = null;

            if (null == convertView) {
                convertView = new ListViewItem(ListViewDragActivity.this);
                convertView.setLayoutParams(new ListView.LayoutParams(-1, mHeight));
                convertView.setBackgroundColor(Color.WHITE);
                textView = (ListViewItem) convertView;
            ...
            convertView.setVisibility((mHidePosition == position) ? View.INVISIBLE : View.VISIBLE);
        ...
        public void swap(int dragPosition, int curPosition) {
            String removeString = mDatas.remove(dragPosition);
            mDatas.add(curPosition, removeString);
            update();
        }
    ...
    private class ListViewItem extends TextView implements IDragSource {
